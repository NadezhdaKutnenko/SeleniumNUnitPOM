...
```
cd existing_repo
git remote add origin https://git.epam.com/nadezhda_kutnenko/at.net-course.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.epam.com/nadezhda_kutnenko/at.net-course/-/settings/integrations)
